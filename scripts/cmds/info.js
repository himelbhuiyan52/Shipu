...
module.exports = {
 ...
 aliases: ["owner", "botinfo" ],
	...
	onStart: async function ({ message }) {
		const authorName = "Himel Bhuiyan";
		const ownAge = "『23』";
		const messenger = " m.me/ntojkuangsyamrmyi.721185";
		const authorFB = " https://www.facebook.com/ntojkuangsyamrmyi.721185";
		const authorNumber = "+8801972224417";
		const Status = "⩸____⩸";
		const urls = [
